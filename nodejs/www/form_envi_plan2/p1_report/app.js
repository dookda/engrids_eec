...
if (typ == "admin") {
    $("#usermenu").append(`<li style="cursor: pointer;"><a onclick='goprofile()'><i class="bi bi-person-square" ></i>&nbsp;<span >${usrname}</span></a></li>
        ...
        <li ><a href="./../../file/MIS-Plan_plan1.pdf" target="_blank"><i class="bi bi-journal-arrow-down"></i>&nbsp;คู่มือระบบติดตามแผนสิ่งแวดล้อมระยะที่ 1
        </a></li>`)
} else {
...
let loadMap = () => {
    let mapbox = L.tileLayer("https://api.mapbox.com/styles/v1/{id}/tiles/{z}/{x}/{y}?access_token=pk.eyJ1IjoiZG9va2RhIiwiYSI6ImNsaW9vNnFnNjBhdWoza29jbzExaWd1OG4ifQ.ISRHvY9tOtX4kVDxEdCD-w", {
        maxZoom: 18,
