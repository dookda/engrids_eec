...
<StyledLayerDescriptor xmlns="http://www.opengis.net/sld" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://www.opengis.net/sld http://schemas.opengis.net/sld/1.1.0/StyledLayerDescriptor.xsd" version="1.1.0" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:ogc="http://www.opengis.net/ogc" xmlns:se="http://www.opengis.net/se">
  <NamedLayer>
    ...
    <UserStyle>
      ...
      <se:FeatureTypeStyle>
        <se:Rule>
          <se:Name>พื้นที่เสี่ยงน้ำท่วมต่ำ</se:Name>
          <se:Description>
            <se:Title>พื้นที่เสี่ยงน้ำท่วมต่ำ</se:Title>
          </se:Description>
        ...
        <se:Rule>
          <se:Name>พื้นที่เสี่ยงน้ำท่วมปานกลาง</se:Name>
          <se:Description>
            <se:Title>พื้นที่เสี่ยงน้ำท่วมปานกลาง</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>flood_clas</ogc:PropertyName>
        ...
        <se:Rule>
          <se:Name>พื้นที่เสี่ยงน้ำท่วมสูง</se:Name>
          <se:Description>
            <se:Title>พื้นที่เสี่ยงน้ำท่วมสูง</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>flood_clas</ogc:PropertyName>
