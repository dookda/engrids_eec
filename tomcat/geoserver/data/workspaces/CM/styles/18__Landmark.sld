          ...
          <se:PointSymbolizer>
            <se:Graphic>
              <se:Mark>
                ...
                <se:Fill>
                  <se:SvgParameter name="fill">#6faaf8</se:SvgParameter>
                  <se:SvgParameter name="fill-opacity">0.86</se:SvgParameter>
                </se:Fill>
                <se:Stroke>
                  <se:SvgParameter name="stroke">#5588f5</se:SvgParameter>
